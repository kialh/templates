...
template = '{0}{1}{2}- {3}{4}{5}{2}{6}{7}{2}{8}{9}{2}{10}{11}{2}{12}{13}{2}{14}{15}{2}{16}{17}{18}'.format(
    "1) Log into "
    "the FortiManager with your windows credentials\n\
...
\t- Source Adddress: ", saddr, "- Destination Address: ", daddr, "- Source Interface: ", interfaces[sif],
    "- Destination Interface: ", interfaces[dif], "- Action: ", act, "- NAT: ", isnat, "- Logging options: ",
    log[islog], "\n\
